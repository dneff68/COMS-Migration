...
?>
<chart
	PYAxisName="Flow Rate (GPH)" 
	SYAxisName="Reading Level / H2S (PPM)" 
...
<? 
if (!empty($READING_DATASET))
{
	echo "
		\n<dataset seriesName='ReadingLevel' renderAs='Line' color='005500' lineThickness='3' parentYAxis='P'>
		$READING_DATASET
		\n</dataset>";
}
?>
