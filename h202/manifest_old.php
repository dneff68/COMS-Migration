...
//http://h202.customhostingtools.com/manifest.php?id=458&eid=mismith@agrium.com
	if ($disp == 0)
	{
...
<table width="700" border="0" cellspacing="1" cellpadding="3">
  ...
  <tr>
    <td class="spinSmallTitle"><strong>US Peroxide<br />
...
<table width="700" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000">
  <tr valign="middle">
    ...
    <td width="226" class="spinSmallTitle"><div align="left">Address</div></td>
    <td width="115" class="spinSmallTitle"><div align="center">Quantity in Gallons </div></td>
    <td width="115" class="spinSmallTitle"><div align="center">Weight in Pounds </div></td>
  </tr>
<?
$cnt = 1;
$totalQuantity = 0;
...
if (checkResult($siteres))
{
	...
	while ($line = mysql_fetch_assoc($siteres))
	{
		...
		$query = "select tankName from tank where tankID = '$monitorID' LIMIT 1";
		...
		echo "\n<tr>
			...
			<td class='spinNormalText'><div align='center'>$quantity_fmt</div></td>
			<td class='spinNormalText'><div align='center'>$weight_fmt</div></td>
		  </tr>";
...
?> 
  <tr>
    ...
    <td class="spinNormalText"><strong><div align="center"><?=number_format($totalQuantity)?></div></strong></td>
