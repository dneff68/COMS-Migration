				...
				<option value="GU" <?= $state=='GU' ? 'selected' : ''?>> Marianas Islands </option>
				...
				<option value="ONT" <?= $state=='ONT' ? 'selected' : ''?>> Ontario - Canada </option>
				...
				<option value="VI" <?= $state=='VI' ? 'selected' : ''?>> Virgin Islands, U.S. </option>
